...
public class AuthenticationController {
	...
	public ApiResponse<Void> passwordLogin(@RequestBody LoginRequest req) {
		return ApiResponse.success();
	}

	@PostMapping("/login/sms")
	public ApiResponse<Void> smsLogin(@RequestBody LoginRequest req) {
		return ApiResponse.success();
	}

	@PostMapping("/login/email")
	public ApiResponse<Void> emailLogin(@RequestBody LoginRequest req) {
		return ApiResponse.success();
	}
